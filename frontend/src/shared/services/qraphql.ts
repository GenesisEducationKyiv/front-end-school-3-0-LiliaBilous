...
export async function createTrack(input: Omit<Track, 'id' | 'createdAt' | 'updatedAt'>): Promise<Result<Track, Error>> {
    try {
...
export async function updateTrack(id: string, input: Partial<Track>): Promise<Result<Track, Error>> {
    try {
